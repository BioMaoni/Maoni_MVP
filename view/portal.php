...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                    ...
                    <div class="collapse-inner" style="padding: 0rem;">
                        ...
                        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#cross_topics">
                            <div class="bg-white collapse-inner rounded" style="padding: 0rem;">
                                <a class="collapse-item" href="portal.php?par=people">People</a>
                                <a class="collapse-item" href="portal.php?par=technology">Technology</a>
                                <a class="collapse-item" href="portal.php?par=onboarding">Onboarding</a>
                                <a class="collapse-item" href="portal.php?par=scaling">Scaling</a>
                                <a class="collapse-item" href="portal.php?par=operations">Operations</a>
                            </div>
                        </div>
                        ...
                        <div id="collapsePagess" class="collapse" aria-labelledby="headingPages" data-parent="#cross_topics">
                            <div class="bg-white collapse-inner rounded" style="padding: 0rem;">
                                <a class="collapse-item" href="portal.php?par=countries">Countries</a>
                                <a class="collapse-item" href="portal.php?par=global">Global Goals</a>
                                <a class="collapse-item" href="portal.php?par=product">Product Offering</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!--
            <li class="nav-item">
                <a class="nav-link" style="padding: .5rem 1rem;" href="portal.php?par=remote">
                    <i class="fas fa-fw fa-folder"></i>
                ...
                <div class="container-fluid ">
                    ...
                    if (isset($_GET['par'])) {
                        if ($_GET["par"] == "historical") {
                            require_once "historicalSentiment.php";
