<div>
    <h3 class="font-weight-bold">1) <u>TERMINOLOGY:</u></h3>
    <br>
    <h5 class="font-weight-bold">What is Topic Modeling?</h5>
    <h6 class="">
        <p>Topic Modelling is an algorithm that applies an iterative process to identify the relationships between semantic structures in a text body and break them down into topics.</p>
    </h6>
    <br>
    <h5 class="font-weight-bold">What is a Key Topic?</h5>
    <h6 class="">
        <p>The topics filtered by our algorithm are referenced as key topics in our interface.</p>
    </h6>
    <br>
    ...
    <h6 class="">
        <p>This powerful tool provides an understanding of how employees feel about a broad range of topics (e.g., departments, goals, products). So, managers and employees can identify conflicts or sources of dissatisfaction among employees.</p>
    </h6>
    <br>
    <h5 class="font-weight-bold">What is the meaning of Frequency and Occurrence?</h5>
    <h6 class="">
        <p>Represents the percentage/number of meetings in which a specific expression appeared. Occurrence, on the other hand, represents how many times a specific expression appeared in a single meeting.</p>
    </h6>
    <br>
</div>